...
![header](https://capsule-render.vercel.app/api?type=waving&color=0:1F3864,100:2F5496&height=280&section=header&text=JangDaeHyeok&fontSize=48&fontColor=ffffff&fontAlignY=40&animation=fadeIn&desc=Back-End%20%C2%B7%20AI%20Infra%20Engineer&descSize=20&descAlignY=68)

<a href="https://jangjjolkit.tistory.com/" target="_blank"><img src="https://img.shields.io/badge/Tech%20Blog-000000?style=for-the-badge&logo=Tistory&logoColor=white"/></a>
<a href="https://jangdaehyeok.notion.site/b3a2b9a3ae7c4e7498a19f0debaed825?pvs=4" target="_blank"><img src="https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=notion&logoColor=white"/></a>
<a href="mailto:jangdaehyeog@gmail.com"><img src="https://img.shields.io/badge/Gmail-EA4335?style=for-the-badge&logo=gmail&logoColor=white"/></a>
...
- ⚙️ **동시성 · 분산 처리**에 관심이 많습니다 — Redis 대기열(Wait Queue), 분산 락(Distributed Lock), 멱등성(Idempotency)을 직접 구현하며 파고들었어요.
- 🤖 요즘은 **AI · RAG · 에이전트**에 푹 빠져 있습니다 — Spring Boot 기반 RAG(수집·질의·하이브리드 검색), Python 하네스, MCP 기반 지식 허브를 실험 중입니다.
- 📝 배운 건 **기술 블로그(장쫄깃)**에 정리하고, "동작하는 코드"보다 **"왜 그렇게 했는지"를 남기는 것**을 더 중요하게 생각합니다.
